...
/**
 * Provides a static method to start a browser. Relies on the original
 * BrowserLauncher implementation, but provides additional support for JNLP.
 */
public class BrowserLauncher2 {
    ...
    public static void openURL2(String url) throws IOException {
        try { // attempt to use Desktop library from JDK 1.6+ (even if on 1.5)
            ...
            Method browse = desktop.getDeclaredMethod("browse",
                    new Class[] { java.net.URI.class });
            browse.invoke(desktopObj, new Object[] { URI.create(url) });
            return;
        ...
        // In case of security exception try applet or JNLP.
            ...
            try {
               ...
               //(BasicService)ServiceManager.lookup("javax.jnlp.BasicService");
                ...
                Method lookup = servicemanagerclass.getMethod("lookup",
                        new Class[] { String.class });
                Object basicservice = lookup.invoke(null,
                ...
                Method showdocument = basicserviceclass.getMethod(
